...
print("可用的模型架构:", list(ARCH_MODEL_REGISTRY.keys()))
print("可用的模型:", list(MODEL_REGISTRY.keys()))
...
from old.utils import checkpoint_utils
...
def main(cfg: FairseqConfig) -> None:
    ...
    # bitfit 用于实现 BitFit（Bias-term Fine-tuning）微调策略的，高效的参数高效微调方法。
    # if cfg.model.bitfit:
